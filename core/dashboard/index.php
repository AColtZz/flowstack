<?php
// Logic to detect websites
$htdocs_path = __DIR__;
// Filter out system folders and files
$websites = array_filter(glob('*'), function($file) {
    return is_dir($file) && !in_array($file, ['phpmyadmin', 'unused_folder']);
});
        ...
        <section class="content">
          <?php if ($page == 'overview'): ?>
            <div class="cards">
              <article class="card">
                ...
                <p class="card__hint">In D:\H\htdocs</p>
              </article>
              <article class="card">
          ...
          <?php elseif ($page == 'phpinfo'): ?>
            <style>
                ...
                .phpinfo-container { font-size: 0.8rem; color: var(--text-main); }
                .phpinfo-container table { width: 100%; border-collapse: collapse; margin-bottom: 20px; table-layout: fixed; word-wrap: break-word; }
                .phpinfo-container th, .phpinfo-container td { 
                    border: 1px solid var(--border-subtle); 
                    padding: 8px; 
                    text-align: left; 
                }
                .phpinfo-container th { background: rgba(110, 242, 255, 0.1); color: var(--accent); }
                .phpinfo-container .e { background: rgba(255, 255, 255, 0.03); width: 300px; font-weight: 600; } /* Key column */
                .phpinfo-container .v { color: var(--text-muted); overflow-x: auto; } /* Value column */
                .phpinfo-container h1, .phpinfo-container h2 { color: var(--accent-alt); }
